...
import Image2 from "../assets/gym-register.jpg";
  ...
  return (
    <div>
      <div className="mt-5 text-black  rounded-xl bg-background space-y-10 ">
        <div className="w-full sm:max-w-[1000px] p-4 space-y-5 bg-gray-500 rounded-md  m-auto">
        ...
        <div className="w-full sm:max-w-[1000px] p-4 space-y-5 bg-gray-500 rounded-md m-auto">
          ...
          <img className="p-2 m-auto" src={Image2} alt="Gym" />
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <img
                className={`w-7 h-7 ${
